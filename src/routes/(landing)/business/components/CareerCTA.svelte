<div class="relative py-16">
	<div
		class="absolute inset-x-0 top-0 hidden h-1/2 bg-neutral-50 dark:bg-neutral-900 lg:block"
		aria-hidden="true"
	/>
	<div class="mx-auto max-w-7xl bg-indigo-600 lg:bg-transparent lg:px-8">
		<div class="lg:grid lg:grid-cols-12">
			...
			>
				<div
					class="dark:bg-neutral-900bg-gray-50 absolute inset-x-0 h-1/2 bg-neutral-50 lg:hidden"
					aria-hidden="true"
				/>
